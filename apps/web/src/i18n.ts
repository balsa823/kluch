...
export const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "view.list":"List","view.map":"Map","map.approx":"Approximate location — exact address shared on enquiry",
  ...
  sr: {
    ...
    "view.list":"Lista","view.map":"Mapa","map.approx":"Približna lokacija — tačna adresa se dijeli na upit",
  ...
  ru: {
    ...
    "view.list":"Список","view.map":"Карта","map.approx":"Приблизительное расположение — точный адрес сообщаем по запросу",
  ...
  tr: {
    ...
    "view.list":"Liste","view.map":"Harita","map.approx":"Yaklaşık konum — kesin adres talep üzerine paylaşılır",
