...
export const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "view.list":"List","view.map":"Map","map.approx":"Approximate location — exact address shared on enquiry","map.jumpToCity":"Jump to city",
  ...
  sr: {
    ...
    "view.list":"Lista","view.map":"Mapa","map.approx":"Približna lokacija — tačna adresa se dijeli na upit","map.jumpToCity":"Skoči na grad",
  ...
  ru: {
    ...
    "view.list":"Список","view.map":"Карта","map.approx":"Приблизительное расположение — точный адрес сообщаем по запросу","map.jumpToCity":"Перейти к городу",
  ...
  tr: {
    ...
    "view.list":"Liste","view.map":"Harita","map.approx":"Yaklaşık konum — kesin adres talep üzerine paylaşılır","map.jumpToCity":"Şehre git",
