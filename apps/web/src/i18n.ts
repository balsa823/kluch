...
export const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "view.list":"List","view.map":"Map","map.approx":"Approximate location — exact address shared on enquiry","map.jumpToCity":"Jump to city","map.toTop":"Back to top","map.fitScreen":"Fit map to screen","map.below":"Jump below the map",
  ...
  sr: {
    ...
    "view.list":"Lista","view.map":"Mapa","map.approx":"Približna lokacija — tačna adresa se dijeli na upit","map.jumpToCity":"Skoči na grad","map.toTop":"Na vrh","map.fitScreen":"Uklopi mapu u ekran","map.below":"Ispod mape",
  ...
  ru: {
    ...
    "view.list":"Список","view.map":"Карта","map.approx":"Приблизительное расположение — точный адрес сообщаем по запросу","map.jumpToCity":"Перейти к городу","map.toTop":"Наверх","map.fitScreen":"Вписать карту в экран","map.below":"Под картой",
  ...
  tr: {
    ...
    "view.list":"Liste","view.map":"Harita","map.approx":"Yaklaşık konum — kesin adres talep üzerine paylaşılır","map.jumpToCity":"Şehre git","map.toTop":"Başa dön","map.fitScreen":"Haritayı ekrana sığdır","map.below":"Haritanın altına",
