...
const en: Dict = {
  ...
  statusScheduled: "a repair has been scheduled",
  statusDone: "resolved ✅",
...
const ru: Dict = {
  ...
  statusReceived: "принята",
  statusScheduled: "ремонт запланирован",
  statusDone: "решено ✅",
  statusCancelled: "закрыто",
...
const me: Dict = {
  ...
  statusReceived: "primljena",
  statusScheduled: "popravka je zakazana",
  statusDone: "riješeno ✅",
  statusCancelled: "zatvoreno",
